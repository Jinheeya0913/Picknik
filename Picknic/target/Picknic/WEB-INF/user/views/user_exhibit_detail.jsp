...
<head>
    ...
    <style><%@include file="/resources/user/css/user_exhibition_detail.css"%></style>
...
<div class="container">
    ...
    <div class="journalSection">
        ...
        <div class="box_img">
            <img class="journal_img" src="/resources/user/imgs/journal.png">
        </div>
