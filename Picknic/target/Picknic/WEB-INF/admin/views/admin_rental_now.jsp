        ...
        <main class="main_container">
            <div class="container-fluid px-4">
                ...
                <ol class="breadcrumb mb-4">
                    ...
                    <li class="breadcrumb-item active">렌탈 진행 리스트</li>
                </ol>
                <div class="card mb-4">
                    <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="button_container">
                                        <input type="button" class="table_btn" value="담당자변경">
                                        <input type="button" class="table_btn" value="기한변경">
                                        <input type="button" class="table_btn" value="폐지">
                                    </div>
                                </td>
                            </tr>
                            <tr>
